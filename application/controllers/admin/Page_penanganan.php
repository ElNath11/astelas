...
class Page_penanganan extends CI_Controller {
	...
	public function index()
	{
			...
			$data["form_data"]=$this->t_page_penanganan->getPage('1');/* View */
			$this->load->view('dashboard/page_penanganan',$data);
		...
		public function update()
	{
		...
		$this->t_page_penanganan->update($data,'1');
		$data['proses'] = true;
		...
		redirect(base_url("index.php/admin/page_penanganan"));
		// $this->index($data);
	}
