...
class Page_penyebab extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('t_page_penyebab');
	...
	public function index()
	{
			...
			$data["form_data"]=$this->t_page_penyebab->getPage('1');/* View */
			$this->load->view('dashboard/page_penyebab',$data);
		...
		public function update()
	{
		...
		$oldpic4 = $this->input->post('oldpic4');
		...
		{
			$img = $this->upload->data();
			$data['img4']=$img['file_name'];
			if (file_exists("./uploads/".$oldpic4)) {
				unlink("./uploads/".$oldpic4);
			}
		}


		$this->t_page_penyebab->update($data,'1');
		$data['proses'] = true;
		...
		redirect(base_url("index.php/admin/page_penyebab"));
		// $this->index($data);
	}
