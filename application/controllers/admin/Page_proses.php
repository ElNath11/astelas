...
class Page_proses extends CI_Controller {
	...
	public function index()
	{
			...
			$data["form_data"]=$this->t_page_proses->getPage('1');/* View */
			$this->load->view('dashboard/page_proses',$data);
		...
		public function update()
	{
		...
		$this->t_page_proses->update($data,'1');
		$data['proses'] = true;
		...
		redirect(base_url("index.php/admin/page_proses"));
		// $this->index($data);
	}
