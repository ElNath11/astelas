...
class Page_galeri extends CI_Controller {
	...
	public function index()
	{
			...
			$data["form_data"]=$this->t_page_galeri->getPage('1');/* View */
			$this->load->view('dashboard/page_galeri',$data);
		...
		public function update()
	{
		...
		$this->t_page_galeri->update($data,'1');
		$data['proses'] = true;
		...
		redirect(base_url("index.php/admin/page_galeri"));
		// $this->index($data);
	}
