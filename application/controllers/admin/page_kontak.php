...
class Page_kontak extends CI_Controller {
	...
	public function index()
	{
			...
			$data["form_data"]=$this->t_page_kontak->getPage('1');/* View */
			$this->load->view('dashboard/page_kontak',$data);
		...
		public function update()
	{
		...
		$this->t_page_kontak->update($data,'1');
		$data['proses'] = true;
		...
		redirect(base_url("index.php/admin/page_kontak"));
		// $this->index($data);
	}
