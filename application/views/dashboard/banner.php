<div id="page-wrapper">
	<div class="row">
		<!-- Head -->
		<div class="col-lg-12">
			<h1 class="page-header">Slider Beranda</h1>
		</div>
		<!-- Head -->
		<!-- Content -->
					...
					<div class="panel-body">
						<div class="dataTable_wrapper">
							<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								<thead>
									<a href="<?php echo base_url("");?>index.php/admin/banner/tambah_view">
										...
										if (!$banner) {
											...
											foreach ($banner as $key => $value) {
												...
												<td class="center">
													...
													<td>
														<a href="<?php echo base_url("");?>index.php/admin/banner/update_view/<?php echo $value->id; ?>">
															<button type="button" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></button>
														</a>
														<?php if($value->flag==2){ ?>
														<a href="<?php echo base_url("");?>index.php/admin/banner/status/1/<?php echo $value->id; ?>"><button class="btn btn-sm btn-danger">
															<i class="ace-icon fa fa-trash-o bigger-120">&nbsp; Disabled</i>
														</button></a>
														<?php }elseif($value->flag==1){ ?>
														<a href="<?php echo base_url("");?>index.php/admin/banner/status/2/<?php echo $value->id; ?>"><button class="btn btn-sm btn-warning">
