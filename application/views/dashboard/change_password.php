    ...
    <body>
        <div class="container">
            ...
            <?php if ($this->session->flashdata('Password')) {
                ...
                Password yang diisi tidak sama
            </div><?php } ?>
            <!-- Notification -->
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div class="login-panel panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <form action="<?php echo base_url("");?>index.php/admin/dashboard/update_password" method="POST">
                                <fieldset>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Password Baru" name="id" type="hidden" value="<?php echo $admin[0]->id;  ?>">
                                        <input class="form-control" placeholder="Password Baru" name="pass1" type="password">
                                    </div>
                                    <div class="form-group">
                                        <input class="form-control" placeholder="Ulangi Password Baru" name="pass2" type="password">
                                    </div>
