		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					...
					<?php if (isset($update)) { ?>action="<?php echo base_url("");?>index.php/admin/banner/update/<?php echo $form_data[0]->id; ?>"
					<?php }else{ ?> action="<?php echo base_url("");?>index.php/admin/banner/add" <?php } ?> method="POST" enctype="multipart/form-data">
